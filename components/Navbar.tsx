...
export const Navbar = () => {
  ...
  return (
    <nav
      ...
      className={`bg-white/95 backdrop-blur-md border-b border-gray-100 fixed top-0 right-0 z-50 px-4 md:px-12 py-3 md:py-5 flex justify-between items-center transition-transform duration-300 shadow-sm print:hidden ${isDashboard ? 'lg:left-24 left-0' : 'left-0'}`}
    >
      <Link href="/" className="text-xl md:text-2xl font-black tracking-tighter uppercase whitespace-nowrap">
